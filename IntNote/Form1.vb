...
Public Class Form1
    ...
    Private Sub AboutNotepadCloneToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AboutNotepadCloneToolStripMenuItem.Click
        MessageBox.Show("Int-Note - Text editor in dark mode" & vbCrLf & "https://github.com/intrepidis/Int-Note", "About Int-Note", MessageBoxButtons.OK)
    End Sub

    Private Sub AboutToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AboutToolStripMenuItem.Click
        MessageBox.Show("Visit https://github.com/intrepidis/Int-Note for details about this app.", "Help & Info", MessageBoxButtons.OK)
    End Sub
    ...
    Private Sub ChangelogToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChangelogToolStripMenuItem.Click
        MessageBox.Show("Int-Note" & vbCrLf & "- Forked from Deybedanta WinNote 1.1.", "What's New?", MessageBoxButtons.OK)
    End Sub
End Class
